/*****************************************************************************/
/* THIS IS COPIED FROM CYRILLUX: DO REST CALLS FOR APP'S BACKEND ROUTES.     */
/* We should merge this and restCalls.js                                     */
/* restCalls.js probably has some shit that is app-specific                  */
/*****************************************************************************/
...
export function restApplyFixersToRecord(record) { // Used by: Cyrillux

  const restCallConfig = {
    url: `${RESTurl}/record/validate`,
    method: 'POST',
    contentType: 'application/json',
    body: record,
    resultAsJson: true
...
export function transliterateRecordByStandards(transliterationData) { // Cyrillux, think of a better function name
...
export function updateRecord(melindaId, record) {
  const restCallConfig = {
