...
export function initAbstracts() {
  ...
  document.getElementById('tiivistelma-abstrakti').addEventListener('input', abstractCharacterCounter);

  document.getElementById('tiivistelma-lisaa-form').addEventListener('reset', resetAbstractCharacterCounter);
...
export function refreshAbstractList(skipUpdate = false) {
...
export function abstractCharacterCounter(event) {
...
export function resetAbstractCharacterCounter(event) {
  document.getElementById('tiivistelma-merkkiraja').innerHTML = '0/5000';
  const warning = document.getElementById('tiivistelma-merkkirajan-ylitys');
  warning.innerHTML = '';
  warning.style.padding = '';
}
